...
public class MixerGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MixerGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(AdvancedmachineryModMenus.MIXER_GUI.get(), id);
