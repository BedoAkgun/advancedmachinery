 ...
 *
 */
package net.groupproject.advancedmachinery;
...
@Mod("advancedmachinery")
public class AdvancedmachineryMod {
	public static final Logger LOGGER = LogManager.getLogger(AdvancedmachineryMod.class);
	public static final String MODID = "advancedmachinery";

	public AdvancedmachineryMod() {
